...
Synology VideoStation ffmpeg wrapper with DTS, EAC3 and TrueHD support. It enables hardware transcoding from ffmpeg from Synology for video and transcoding DTS, HEVC, EAC3, AAC from the ffmpeg of the SynoCommunity.
...
************************************************************************
# With this wrapper (ffmpeg41-wrapper file) you will be with the original ffmpeg almost time and only you will use the ffmpeg 4.31 when is 100% necessary. You will need Putty or other SSH Client in order to connect.
...
3.b) wget -O - https://raw.githubusercontent.com/darknebular/Wrapper_VideoStation/main/ffmpeg41-wrapper-DSM7_1 > /var/packages/CodecPack/target/pack/bin/ffmpeg41
