...
# SCPT_1.11: Adding the function for checking and expand error logs. Minimal changes. Improvement the Configurator menu when It's launched if you haven't MediaServer Installed.
